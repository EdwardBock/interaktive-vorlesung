...
public interface Constants {
	...
	public static final String DELETE_TABLE_QUESTS = "DROP TABLE "+TABLE_QUESTS;
	public static final String CREATE_TABLE_QUESTS = "CREATE TABLE IF NOT EXISTS " + TABLE_QUESTS +
			" ("+
			TABLE_QUEST_ID+" INTEGER PRIMARY KEY," +
			TABLE_QUEST_QUESTION+" TEXT NOT NULL, " +
			TABLE_QUEST_ANSWER+" VARCHAR(200) NOT NULL, " +
			TABLE_QUEST_A+" INTEGER, " +
			TABLE_QUEST_B+" INTEGER, "+
			TABLE_QUEST_C+" INTEGER," +
