...
public class SQLDataHandler extends SQLiteOpenHelper {
	...
	public static String TABLE_ANSWERS_ID = "_id";
	public static String TABLE_ANSWERS_QUESTION = "question";
	public static String TABLE_ANSWERS_CORRECT = "correct";
	public static String TABLE_ANSWERS_TEXT = "answer";
	// Statistiken lokal speichern? Eher nicht, weil sie während der Stimmabgabe
	// nicht aktuell sein müssen
	public static String TABLE_ANSWERS_COUNT_A = "a";
	public static String TABLE_ANSWERS_COUNT_B = "b";
	public static String TABLE_ANSWERS_COUNT_C = "c";
	public static String TABLE_ANSWERS_COUNT_D = "d";
	...
	public boolean addCourse(Course course) {
		...
		String sqlQuery = "SELECT _id FROM " + TABLE_COURSES + " WHERE _id="
				+ course.getID();
