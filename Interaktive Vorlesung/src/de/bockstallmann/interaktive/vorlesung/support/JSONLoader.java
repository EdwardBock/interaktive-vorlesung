...
public class JSONLoader extends Thread {
	...
	public void startGetCourse(final int id){
		scriptPath = "script_get_course.php?id="+id;
		this.start();
	}
	...
	public void startGetCollectionBySession(final int session_id){
		scriptPath = "script.app.active_collection_by_session.php?s_id="+session_id;
		this.start();
	}
